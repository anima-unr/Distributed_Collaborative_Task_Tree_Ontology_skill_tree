...
static const char *static_object_str[] = {
  ...
  "Meat",
  "Lettuce",
  "blue_leg","green_leg","yellow_bar","pink_bar","orange_top","purple_top"
  //"Sandwich",
  //"Apple",
  //"Orange"
};
...
void TableObject_VisionManip::UpdateActivationPotential() {
  ...
  if( neutral_object_pos.size() == 0 ) {
    ...
    mx = my = mz = 0;
    state_.activation_potential = 0.01;
    return;
  }
  else {
  ...
  else state_.activation_potential = 0.01;
...
bool TableObject_VisionManip::ActivationPrecondition() {
  ...
  ROS_ERROR("checking mutex is locking or not %f",state_.activation_potential);
...
void TableObject_VisionManip::Work() {
  ...
  table_setting_demo::object_position pos_msg;
    ...
    ROS_WARN("Waiting to pick up object [%s]!\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", object_.c_str());
